      ...
      case "speciality":
        return (
          <div>
            ...
            <p>Highlight HydroTrim’s special focus areas and expertise.</p>
          </div>
        );
      case "about":
        return (
          <div>
            ...
            <p>HydroTrim aims to combat water-borne diseases through smart monitoring and analytics.</p>
          </div>
        );
      case "international":
        return (
          <div>
            ...
            <p>Information about HydroTrim’s international collaborations and global impact.</p>
          </div>
        );
      case "blogs":
        return (
          <div>
            ...
            <p>Latest blog posts, research, and health tips related to water-borne diseases.</p>
          </div>
        );
      case "news":
        return (
          <div>
            ...
            <p>Recent news, events, and updates in the water-health domain.</p>
          </div>
        );
      case "contact":
        return (
          <div>
            ...
            <p>For inquiries or feedback, please contact us at: <strong>support@hydrotrim.org</strong></p>
          </div>
        );
      default:
        return (
  ...
  return (
    <div className={`d-flex min-vh-100 ${localStorage.getItem("darkMode") === "true" ? "bg-dark text-light" : "bg-light"}`}>
      ...
      <div style={{ width: "250px" }} className="d-flex flex-column">
        ...
        <aside className="bg-dark text-white p-3 flex-grow-1 d-flex flex-column">
          <h4 className="mb-4">{translations[language].adminPanel}</h4>
          <button className="btn btn-dark text-start mb-2" onClick={() => setActivePage("dashboard")}>
            📊 {translations[language].dashboard}
          </button>
